...
namespace HoshinoLabs.Sardinal.Udon {
    internal sealed class SignalSerializer : UdonSharp.Serialization.Serializer {
        ...
        public SignalSerializer(UdonSharp.Serialization.TypeSerializationMetadata typeMetadata)
            : base(typeMetadata) {
